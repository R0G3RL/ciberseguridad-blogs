...
<opml version="1.0">
    <head>
        <title>ciberseguridad blogs</title>
    </head>
    <body>
        <outline text="ciberseguridad blogs" title="ciberseguridad blogs">
{items}
        </outline>
    </body>
</opml>
...
open('ciberseguridad.opml', 'w').write(xmlbody.format(items=items[0:-2]))
